      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="grid gap-8 lg:grid-cols-5">
          ...
          >
            ...
            <HudFrame className="mt-8 rounded-lg border border-[rgb(var(--border))] bg-[rgb(var(--panel)/60%)] p-6">
              <div className="flex items-start gap-3">
                <GraduationCap size={20} className="mt-1 shrink-0 text-[rgb(var(--blue))]" />
                <div>
                  ...
                  <ul className="mt-4 flex flex-wrap gap-2">
                    {profile.education.modules.map((m) => (
                      <li
                        key={m}
                        className="rounded border border-[rgb(var(--border))] px-2.5 py-1 font-[family-name:var(--font-mono)] text-[11px] text-[rgb(var(--muted))]"
                      >
                        {m}
                      </li>
                    ))}
