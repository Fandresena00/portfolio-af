...
const statusStyles: Record<ProjectStatus, string> = {
  "In production": "border-[rgb(var(--blue)/40%)] text-[rgb(var(--blue))]",
  "In development": "border-[rgb(var(--amber)/40%)] text-[rgb(var(--amber))]",
  "Completed": "border-[rgb(var(--muted)/40%)] text-[rgb(var(--muted))]",
};
    ...
    <section id="projects" className="relative border-t border-[rgb(var(--border-soft))] py-24">
      <div className="mx-auto max-w-6xl px-6">
        <SectionHeading
          ...
          description="Three platforms designed and built end to end, from the interface down to the database."
        />
