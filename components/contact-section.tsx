...
const channels = [
  ...
  { label: "Site", value: profile.website.replace("https://", "fandresena.fadevt.org"), href: profile.website, icon: Globe },
{
  label: "GitHub",
  value: profile.github.replace("https://", "https://github.com/Fandresena00/portfolio-af"),
  href: profile.github,
  icon: FaGithub,
},
];
...
export function ContactSection() {
  return (
    <section id="contact" className="relative border-t border-[rgb(var(--border-soft))] py-24">
              ...
              {channels.map(({ label, value, href, icon: Icon }) => (
                ...
                >
                  ...
                  <span>
                    ...
                    <span className="block text-sm text-[rgb(var(--text))]">{value}</span>
                  </span>
                </a>
              ))}
            </div>
